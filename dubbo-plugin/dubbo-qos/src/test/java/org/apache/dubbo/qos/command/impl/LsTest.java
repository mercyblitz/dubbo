...
public class LsTest {
    ...
    public void testExecute() throws Exception {
        ...
        ApplicationModel.getDefaultApplicationModel().registerProviderInvoker(providerInvoker, registryUrl, providerUrl);
        for (ProviderInvokerWrapper wrapper : ApplicationModel.getDefaultApplicationModel().getProviderInvokers("org.apache.dubbo.BarService")) {
            wrapper.setReg(true);
        }
        ...
        ApplicationModel.getDefaultApplicationModel().registerConsumerInvoker(consumerInvoker, consumerUrl.getServiceKey());
